---
name: a11y-keyboard-flow-check
description: "Draft small keyboard navigation smoke checks for validating accessibility marketplace installation and skill discovery."
...
# A11y Keyboard Flow Check

Use this placeholder skill to verify that the accessibility testing marketplace plugin imports correctly.
