---
name: aqa-api-test-smoke
description: "Prepare lightweight API automation smoke scenarios for validating AQA marketplace installation and skill import behavior."
owner: QE Practice VS
metadata:
  sdlc_phase: [development, testing]
  technologies: [api, pytest]
authors:
...
Use this placeholder skill to verify that the automated testing marketplace plugin imports correctly.
