---
name: perf-k6-smoke-check
description: "Create small k6-oriented performance smoke checks for marketplace validation and performance plugin discovery tests."
